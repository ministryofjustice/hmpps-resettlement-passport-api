...
import uk.gov.justice.digital.hmpps.hmppsresettlementpassportapi.data.PrisonerManagers
...
class AllocationManagerApiService(val allocationManagerWebClientCredentials: WebClient) {
  ...
  fun getPomsByNomsId(nomsId: String): PrisonerManagers {
    ...
    return PrisonerManagers(primaryPomName, secondaryPomName)
  }
