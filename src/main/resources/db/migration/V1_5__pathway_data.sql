...
insert into pathway (id, name, active ) values (5, 'Education, skills and work', true);
insert into pathway (id, name, active ) values (6, 'Finance and ID', true);
insert into pathway (id, name, active ) values (7, 'Health', true);
