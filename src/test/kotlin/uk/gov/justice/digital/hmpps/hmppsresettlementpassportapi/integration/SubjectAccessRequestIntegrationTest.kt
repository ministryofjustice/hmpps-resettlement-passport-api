...
class SubjectAccessRequestIntegrationTest : IntegrationTestBase() {
  ...
  private final val expectedAssessment = "assessment={id=1, $expectedPrisoner, creationDate=2023-08-16T12:21:38.709, " +
  ...
  private final val expectedBankApplication = "bankApplication={id=1, prisoner={id=1, nomsId=G1458GV, creationDate=2024-01-01T12:21:38.709, " +
    "crn=ABC123, prisonId=null, releaseDate=null}, logs=[], applicationSubmittedDate=2023-08-16T12:21:38.709, currentStatus=Application submitted, " +
    "bankName=Nationwide, bankResponseDate=null, isAddedToPersonalItems=false, addedToPersonalItemsDate=null}"
  ...
  private final val expectedIdApplication = "idApplication={id=1, " +
    "prisoner={id=1, nomsId=G1458GV, creationDate=2024-01-01T12:21:38.709, crn=ABC123, prisonId=null, releaseDate=null}, " +
    "idType={id=2, name=Marriage certificate}, creationDate=2023-08-16T12:21:38.709, applicationSubmittedDate=2023-08-16T12:21:38.709, " +
