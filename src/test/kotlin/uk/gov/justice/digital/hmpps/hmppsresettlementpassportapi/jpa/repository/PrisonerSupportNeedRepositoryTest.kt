...
class PrisonerSupportNeedRepositoryTest : RepositoryTestBase() {
  ...
  fun `test findAllByPrisonerIdAndDeletedIsFalse - no results`() {
    Assertions.assertEquals(
      listOf<PrisonerSupportNeedEntity>(),
      prisonerSupportNeedRepository.findAllByPrisonerIdAndDeletedIsFalse(1),
    )
  }
  ...
  fun `test getPrisonerSupportNeedsByPrisonId`() {
    val expectedPrisonerSupportNeeds = listOf(
      arrayOf<Any?>(2L, "G4161UF", Pathway.ACCOMMODATION, LocalDateTime.parse("2024-02-21T09:36:28.713421"), false, 3L, SupportNeedStatus.MET, LocalDateTime.parse("2024-02-22T09:36:31.713421"), false, true),
      arrayOf<Any?>(3L, "G4161UF", Pathway.ACCOMMODATION, LocalDateTime.parse("2024-02-21T09:36:28.713421"), true, null, null, null, null, null),
      arrayOf<Any?>(5L, "G4161UG", Pathway.ACCOMMODATION, LocalDateTime.parse("2024-02-21T09:36:28.713421"), false, null, null, null, null, null),
      arrayOf<Any?>(6L, "G4161UF", Pathway.ACCOMMODATION, LocalDateTime.parse("2024-02-21T09:36:28.713421"), false, null, null, null, null, null),
    )
  ...
  fun `test findAllByPrisonerIdAndSupportNeedPathway`() {
    ...
    assertThat(prisonerSupportNeedRepository.findAllByPrisonerIdAndSupportNeedPathway(1, Pathway.ACCOMMODATION))
      .containsExactlyInAnyOrder(*expectedSupportNeeds.toTypedArray())
  }
    ...
    fun `should return matching needs within date range`() {
      val expectedPrisonerSupportNeeds = listOf(
        PrisonerSupportNeedEntity(
          ...
          otherDetail = null,
          createdBy = "Someone",
          createdDate = LocalDateTime.parse("2024-02-21T09:36:28.713421"),
          deleted = true,
          deletedDate = LocalDateTime.parse("2024-02-21T09:37:28.713421"),
        ),
        PrisonerSupportNeedEntity(
          id = 2,
          prisonerId = 1,
        ...
        PrisonerSupportNeedEntity(
          id = 3,
          prisonerId = 1,
          supportNeed = supportNeedRepository.findById(7).get(),
          otherDetail = null,
          createdBy = "Someone",
          createdDate = LocalDateTime.parse("2024-02-21T09:36:28.713421"),
          deleted = false,
        ...
        PrisonerSupportNeedEntity(
          id = 6,
          prisonerId = 1,
          supportNeed = supportNeedRepository.findById(6).get(),
          otherDetail = "This is an other 1",
