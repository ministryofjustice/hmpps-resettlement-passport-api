...
class SupportNeedsLegacyProfileServiceTest {
  ...
  fun `test addLegacySupportNeeds`() {
    ...
    whenever(supportNeedRepository.findAllBySectionAndDeletedIsFalse("Legacy support need")).thenReturn(
      listOf(
    ...
    whenever(prisonerRepository.findAllBySupportNeedsLegacyProfileIsTrue()).thenReturn(
      listOf(
    ...
    verify(prisonerSupportNeedRepository).saveAll(
      listOf(
