...
class AttitudesThinkingAndBehaviourResettlementAssessmentStrategyTest {
  ...
  private fun `test next page function flow - no existing assessment data`() = Stream.of(
    ...
    // Any answer to HELP_TO_MANAGE_ANGER, go to INFLUENCED_BY_OTHERS
    Arguments.of(
      listOf<ResettlementAssessmentRequestQuestionAndAnswer<*>>(
    ...
    // Any answer to INFLUENCED_BY_OTHERS, go to ISSUES_WITH_GAMBLING
    Arguments.of(
      listOf<ResettlementAssessmentRequestQuestionAndAnswer<*>>(
        ResettlementAssessmentRequestQuestionAndAnswer("HELP_TO_MANAGE_ANGER", answer = StringAnswer("YES")),
        ResettlementAssessmentRequestQuestionAndAnswer("INFLUENCED_BY_OTHERS", answer = StringAnswer("NO")),
      ),
      "INFLUENCED_BY_OTHERS",
      "ISSUES_WITH_GAMBLING",
    ),
    // Any answer to ISSUES_WITH_GAMBLING, go to INVOLVED_IN_GANG_ACTIVITY
    Arguments.of(
      listOf<ResettlementAssessmentRequestQuestionAndAnswer<*>>(
        ResettlementAssessmentRequestQuestionAndAnswer("HELP_TO_MANAGE_ANGER", answer = StringAnswer("YES")),
        ResettlementAssessmentRequestQuestionAndAnswer("INFLUENCED_BY_OTHERS", answer = StringAnswer("NO")),
    ...
    // Any answer to INVOLVED_IN_GANG_ACTIVITY, go to UNDER_THREAT_OUTSIDE_PRISON
    Arguments.of(
      listOf<ResettlementAssessmentRequestQuestionAndAnswer<*>>(
        ResettlementAssessmentRequestQuestionAndAnswer("HELP_TO_MANAGE_ANGER", answer = StringAnswer("YES")),
        ResettlementAssessmentRequestQuestionAndAnswer("INFLUENCED_BY_OTHERS", answer = StringAnswer("NO")),
        ResettlementAssessmentRequestQuestionAndAnswer("ISSUES_WITH_GAMBLING", answer = StringAnswer("NO_ANSWER")),
        ResettlementAssessmentRequestQuestionAndAnswer("INVOLVED_IN_GANG_ACTIVITY", answer = StringAnswer("NO")),
      ),
      "INVOLVED_IN_GANG_ACTIVITY",
      "UNDER_THREAT_OUTSIDE_PRISON",
    ),
    // Any answer to UNDER_THREAT_OUTSIDE_PRISON, go to ASSESSMENT_SUMMARY
    Arguments.of(
      listOf<ResettlementAssessmentRequestQuestionAndAnswer<*>>(
        ResettlementAssessmentRequestQuestionAndAnswer("HELP_TO_MANAGE_ANGER", answer = StringAnswer("YES")),
        ResettlementAssessmentRequestQuestionAndAnswer("INFLUENCED_BY_OTHERS", answer = StringAnswer("NO")),
