...
(1, 1, 'ACCOMMODATION', 'SUBMITTED', 'RESETTLEMENT_PLAN', '{"assessment": []}'::jsonb, 'SUPPORT_DECLINED', '2024-07-30 19:02:45.000', 'A User', 'Some accom case notes', 'TEST_GEN'),
(2, 1, 'HEALTH', 'SUBMITTED', 'RESETTLEMENT_PLAN', '{"assessment": []}'::jsonb, 'SUPPORT_DECLINED', '2024-07-30 19:02:45.000', 'A User', 'Some health case notes', 'TEST_GEN'),
(3, 1, 'HEALTH', 'COMPLETE', 'RESETTLEMENT_PLAN', '{"assessment": []}'::jsonb, 'SUPPORT_DECLINED', '2024-07-30 19:02:45.000', 'A User', 'Some previous notes', 'TEST_GEN'),
(4, 1, 'HEALTH', 'SUBMITTED', 'RESETTLEMENT_PLAN', '{"assessment": []}'::jsonb, null, '2024-07-30 19:02:45.000', 'A User', null, 'TEST_GEN')