...
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
VALUES(9, 1, 'ACCOMMODATION', 'CASE_NOTE', '2023-12-05 17:44:30.091', NULL, NULL, 'This is some case note text.', 'Test User7');
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
VALUES(10, 1, 'ATTITUDES_THINKING_AND_BEHAVIOUR', 'CASE_NOTE', '2023-11-05 10:00:00.001', NULL, NULL, 'Some text related to case note.', 'Test User11');
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
VALUES(11, 1, 'CHILDREN_FAMILIES_AND_COMMUNITY', 'CASE_NOTE', '2023-10-01 09:53:01.001', NULL, NULL, 'Random string.', 'Test User12');
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
...
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
VALUES(15, 1, 'HEALTH', 'CASE_NOTE', '2020-01-09 02:09:23.476', NULL, NULL, 'string test string', 'Test User13');
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
VALUES(16, 1, 'HEALTH', 'CASE_NOTE', '2020-01-09 08:02:02', NULL, NULL, 'string test string - another health case note', 'Test User14');
INSERT INTO delius_contact
(id, prisoner_id, category, contact_type, created_date, appointment_date, appointment_duration, notes, created_by)
VALUES(17, 1, 'ACCOMMODATION', 'CASE_NOTE', '2023-09-05 08:02:02', NULL, NULL, 'Test case note', 'Test User1');
