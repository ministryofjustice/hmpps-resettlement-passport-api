...
VALUES
(1, 'G1458GV', '2023-10-16 12:21:38.709','NGRBG54');
...
VALUES
    (1, 1, 1, 3, 'BCST2', '{"assessment": [{"answer": {"@class": "StringAnswer","answer": "NO_ANSWER"},"questionId": "WHERE_DID_THEY_LIVE"}]}'::jsonb, 1, '2023-10-16 12:21:38.709','Prison Officer');
