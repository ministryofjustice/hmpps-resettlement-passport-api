...
VALUES (1, 1, 'ACCOMMODATION', 'COMPLETE', 'BCST2', '{"assessment": [{"answer": {"@class": "StringAnswer","answer": "NO_ANSWER"},"questionId": "WHERE_DID_THEY_LIVE"}]}'::jsonb, 'NOT_STARTED', '2023-10-16 12:21:38.709','Prison Officer');
